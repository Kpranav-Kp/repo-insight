...
class SkillExtractor:
    SKILLS_DB = {
        ...
        # Web
        "react", "vue", "angular", "svelte", "next.js", "nuxt", "html", "css", "sass", "less",
        # Backend
        ...
        # ML/AI
        "tensorflow", "pytorch", "scikit-learn", "pandas", "numpy", "machine learning", "ai", "llm",
        # Tools
        "git", "webpack", "vite", "babel", "eslint", "prettier",
        # Concepts
        "api", "graphql", "rest", "websocket", "oauth", "jwt", "authentication", "authorization",
